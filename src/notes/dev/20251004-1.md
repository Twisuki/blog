...
![](/notes/dev/20251004-1-1.webp)

- 别管怎么移的, 因为在讨论递归, 所以我们先`一次移动 n - 1 个盘子`, 至于这 n - 1 个盘子的细节, 交个 n - 2 的递归去考虑, 现在不用管.

![](/notes/dev/20251004-1-2.webp)

- 最下面一个盘子直接移过去.

![](/notes/dev/20251004-1-3.webp)

- 同样的, 别管怎么移的, 最后再`一次移动 n - 1 个盘子`, 完成问题.

![](/notes/dev/20251004-1-4.webp)
...
![](/notes/dev/20251004-1-5.webp)

![](/notes/dev/20251004-1-6.webp)
